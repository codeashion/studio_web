    ...
    <div className="min-h-screen pt-16">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="mb-6 animate-fade-in-up">About LensStudio</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in-left">
              ...
              <p className="text-inverted-fg/80 text-lg mb-6">
                Founded with a passion for visual storytelling, LensStudio has been creating compelling content 
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 inverted">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-inverted-fg mb-6 animate-fade-in-up">Why Choose LensStudio</h2>
          </div>
